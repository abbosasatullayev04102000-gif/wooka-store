...
/**
 * Keeps the customer's Supabase session fresh. Runs only on routes that can be
 * personalised — the catalogue stays fully static/cacheable.
 */
...
export const config = {
  matcher: ['/account/:path*', '/checkout/:path*', '/cart'],
}
